...
class BasePhase5D4E2ETest(unittest.IsolatedAsyncioTestCase):
    port = 8830

    @classmethod
    def setUpClass(cls):
        cls.base_url = f"http://127.0.0.1:{cls.port}"
        cls.screenshots_dir = os.path.join(PROJECT_ROOT, "artifacts", "e2e", "phase5d4")
    ...
    async def wait_for_client_connected(self, timeout: float = 5.0) -> bool:
